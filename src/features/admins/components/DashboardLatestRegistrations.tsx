            ...
            {registrations.map((reg) => {
              ...
              return (
                <tr key={reg.id} className="hover:bg-slate-50/50 transition">
                  ...
                  <td className="py-4 px-6">
                    <span
                      className={`inline-flex items-center gap-1 px-2.5 py-1 text-xs font-bold rounded-full border ${statusStyle.bg}`}
                    >
                      {statusStyle.label}
                    </span>
                  </td>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span
                  className={`inline-flex items-center gap-1 px-2.5 py-0.5 text-xs font-bold rounded-full border ${statusStyle.bg}`}
                >
                  {statusStyle.label}
                </span>
              </div>
