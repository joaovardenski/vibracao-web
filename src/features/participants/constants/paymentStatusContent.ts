...
export const paymentStatusContent = {
  approved: {
    ...
    message: "Seu pagamento foi aprovado com sucesso. O comprovante foi enviado para o seu e-mail.",
    icon: CheckCircle2,
  ...
  failure: {
    ...
    message: "Houve um problema ao processar a transação. Verifique os dados ou tente outra forma.",
    icon: XCircle,
